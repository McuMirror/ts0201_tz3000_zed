...
|:-------------------:|:---------------------:|:---------:|:----------------------------:|:-------------:|
| TS0201-z-SlD<br>TS0201-z15-SlD | TS0201 | WSD500A | _TZ3000_xr3htd96<br>_TZ3000_fllyghyj<br>_TZ3000_0s1izerx | OTA file |
...
Чтобы понять, пошло обновление или нет, возвращаемя в пункт `Devies` и смотрим на изображение датчика, там должен появиться вращающийся кружок со стрелками.
